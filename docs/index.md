...
og_image: https://albasimia.github.io/OverCUE/assets/ogp/ja.png?v=20260713-2
...
3. OverCUEのPreset GroupとEXPORT／PERFORMANCEモードを選択します。対象Deckは別指定せず、Deck 1〜4等に分類されたrekordboxショートカット自体を選びます。
...
各Preset Groupはstable ID、名前、順序を持ち、EXPORT／PERFORMANCEモード、波形位置、入力割り当てを保存します。同じPreset内でDeck 1〜4やAll Decks等のshortcut scopeを混在できます。GUI、ACK05、CLI、メニューバーのPresetとモードは連動します。
