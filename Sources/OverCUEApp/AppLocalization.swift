...
final class AppLocalization: ObservableObject {
    ...
    private static let webInterfaceAdditions: [AppLanguage: [String: String]] = [
        .japanese: [
            ...
            "groupPreset.title": "グループプリセット",
            "groupPreset.assignments": "%d台のデバイス",
            "groupPreset.device.help": "含めたデバイスは、このグループプリセットが有効になった時に選択したプリセットから開始します。",
            "preset.reorder": "プリセットを並び替え",
            "preset.reorder.help": "ハンドルをドラッグしてプリセット順を変更します。",
            "shortcuts.overcue": "OverCUE Control",
        ...
        .english: [
            ...
            "groupPreset.title": "Group Preset",
            "groupPreset.assignments": "%d device assignments",
            "groupPreset.device.help": "Included devices start from the selected Preset when this Group Preset becomes active.",
        ...
        .simplifiedChinese: [
            ...
            "groupPreset.title": "组预设",
            "groupPreset.assignments": "%d 个设备分配",
            "groupPreset.device.help": "启用此组预设时，包含的设备会从所选预设开始。",
